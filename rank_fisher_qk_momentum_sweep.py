#!/usr/bin/env python3
"""Rank the focused Fisher-QK momentum sweep by common step and wall time."""
...
def main() -> None:
    ...
    print("\nMatched CG3-vs-CG1 RHS-momentum comparisons:")
    for qk_lr in ["0.00022", "0.00033"]:
        cg3 = next(
            (
                row
        ...
        if cg3 is None or cg1 is None:
            continue
        print(
            f"qk_lr={qk_lr}: CG3={cg3['common_val']:.4f}, "
